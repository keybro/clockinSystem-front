...
<!--          <el-table-column label="用户编号" align="center" key="userId" prop="userId" v-if="columns[0].visible" />-->
          ...
          <el-table-column label="岗位" align="center" key="postName" prop="postName" v-if="columns[4].visible" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.$router.push("/clockin/depClockinUser/"+ userId);
